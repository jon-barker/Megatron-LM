...
LLM="nemotron6_120b_a12b"

ROOT_DIR="/lustre/fsw/portfolios/llmservice/projects/llmservice_fm_text/megatron_rl/models/nemotron6"

CHECKPOINT="${ROOT_DIR}/49b_hybrid_moe_base/"

TOKENIZER_MODEL="${ROOT_DIR}/tokenizers/multiMixV8.gpt4o_nc_sd.500000.128k.vocab.json"

echo "Using Nemotron6 Super model checkpoint"
